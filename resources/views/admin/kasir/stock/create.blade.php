  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <div class="form-check form-switch mb-3">
        ...
        <label class="form-check-label fw-bold" for="deduct_raw_material" style="color: var(--text-primary);">Potong Stok Bahan Mentah Otomatis Saat Membuat Stok Ini</label>
      </div>
