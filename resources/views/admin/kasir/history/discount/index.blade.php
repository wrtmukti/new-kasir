...
<div class="page-header">
  <div>
    <h1>Riwayat Diskon</h1>
    <div class="breadcrumb-trail">
      <a href="{{ url('docs/index') }}">Home</a><i class="bi bi-chevron-right" style="font-size:0.6rem;"></i>
      <span>Riwayat Diskon</span>
    </div>
  </div>
</div>
  ...
  <div class="card-body p-0">
    <div class="table-responsive" id="tableContainer">
      <table class="table-modern" id="dataTable">
        ...
        <tbody id="tableBody">
          @include('admin.kasir.history.discount._data', ['histories' => $histories])
        </tbody>
      </table>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function loadData(page, perPageVal) {
    const url = '{{ route("admin.history.discount.data") }}?page=' + page + '&per_page=' + perPageVal;
