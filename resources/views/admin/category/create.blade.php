...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{ route('admin.category.store') }}" method="POST" class="form-submit-loading" enctype="multipart/form-data">
      @csrf
      <div class="row g-3">
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          ...
          <div class="input-skeleton">
            <input type="text" name="category_name" class="form-control-modern @error('category_name') is-invalid @enderror" value="{{ old('category_name') }}" placeholder="Nama kategori">
            @error('category_name')
        ...
        <div class="col-md-4">
          ...
          <div class="input-skeleton">
            <input type="text" name="category_type" class="form-control-modern" value="{{ old('category_type') }}" placeholder="misal: makanan, minuman">
          </div>
        </div>
        <div class="col-md-6">
          <label class="form-label-modern">Deskripsi</label>
          <div class="input-skeleton">
            <textarea name="category_description" class="form-control-modern" rows="3" placeholder="Deskripsi kategori">{{ old('category_description') }}</textarea>
          </div>
        </div>
        <div class="col-md-3">
          ...
          <div class="input-skeleton">
            <select name="category_status" class="form-select-modern">
              <option value="1" {{ old('category_status', '1') == '1' ? 'selected' : '' }}>Aktif</option>
              <option value="0" {{ old('category_status') === '0' ? 'selected' : '' }}>Nonaktif</option>
            </select>
          </div>
        </div>
        <div class="col-md-3">
