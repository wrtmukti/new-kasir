            ...
            <div class="my-6 px-2">
              <div class="grid grid-cols-3 gap-2 relative text-center">
                ...
                <div class="flex flex-col items-center gap-1.5 z-10">
                  <div class="w-10 h-10 rounded-full bg-secondary-container text-on-secondary-container flex items-center justify-center font-bold shadow-sm border-2 border-white">
