  ...
  <div class="card-main-content">
    ...
    <div class="card-info-body p-4">
      <div class="flex items-center justify-between gap-1.5 mb-1">
        <span class="text-[10px] font-headline font-extrabold uppercase tracking-wider text-on-surface-variant opacity-80 truncate">
          {{ $product->category->category_name ?? 'Spicy Special' }}
        </span>
        <!-- Flame level indicator -->
        <div class="flex gap-0.5 items-center flex-shrink-0 bg-secondary-container/20 px-1.5 py-0.5 rounded-full border border-secondary-container/40">
          <span class="material-symbols-outlined text-secondary-container fill-icon text-[13px]">local_fire_department</span>
          <span class="material-symbols-outlined text-secondary-container fill-icon text-[13px]">local_fire_department</span>
          <span class="material-symbols-outlined text-secondary-container fill-icon text-[13px]">local_fire_department</span>
        </div>
      </div>
