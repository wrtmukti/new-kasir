...
<div class="max-w-3xl mx-auto">
  ...
  <div class="flex items-center gap-3 mb-6">
    ...
    <div>
      ...
      <p class="text-xs text-on-surface-variant font-bold">Meja {{ $table->table_number }} • {{ $outlet->outlet_name ?? 'Ignite & Spice' }}</p>
    </div>
  </div>
  ...
  <div class="bg-white rounded-2xl p-6 border border-surface-variant shadow-xs mb-6">
    ...
    <div class="flex gap-2">
      <input type="text" id="isVoucherInput" value="{{ old('voucher_code') }}" placeholder="Masukkan kode voucher..."
