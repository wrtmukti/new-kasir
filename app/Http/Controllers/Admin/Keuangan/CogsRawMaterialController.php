...
class CogsRawMaterialController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        $query = CogsRawMaterial::where('delete_status', 0);
    ...
    public function store(CogsRawMaterialRequest $request)
    {
        ...
        CogsRawMaterialHistory::create([
            ...
            'changed_by' => 'Admin',
            'effective_date' => now(),
            'history_remark' => 'Membuat bahan mentah COGS baru',
            'created_by' => 'admin',
        ]);

        return redirect()->route('admin.keuangan.cogs-raw-material.index')
            ->with('success', 'Bahan mentah COGS berhasil ditambahkan.');
    }

    public function show($id)
    {
        $cogsRawMaterial = $id instanceof CogsRawMaterial ? $id : CogsRawMaterial::find($id);
    ...
    public function update(CogsRawMaterialRequest $request, $id)
    {
        ...
        $cogsRawMaterial->updated_by = 'admin';
        ...
        CogsRawMaterialHistory::create([
            ...
            'changed_by' => 'Admin',
            'effective_date' => now(),
            'history_remark' => 'Mengubah data bahan mentah COGS',
            'updated_by' => 'admin',
        ]);

        return redirect()->route('admin.keuangan.cogs-raw-material.index')
            ->with('success', 'Bahan mentah COGS berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        $cogsRawMaterial->update(['delete_status' => 1, 'updated_by' => 'admin']);
        ...
        CogsRawMaterialHistory::create([
            ...
            'changed_by' => 'Admin',
            'effective_date' => now(),
            'history_remark' => 'Menghapus bahan mentah COGS',
            'updated_by' => 'admin',
        ]);
